...
func HasCSAMViolationMarker(err *types.AIBridgeError) bool {
	if err == nil {
		return false
	}
...
func WrapAsViolationFeeGrokCSAM(err *types.AIBridgeError) *types.AIBridgeError {
	if err == nil {
		return nil
	}
...
func NormalizeViolationFeeError(err *types.AIBridgeError) *types.AIBridgeError {
	if err == nil {
		return nil
	}
...
func shouldChargeViolationFee(err *types.AIBridgeError) bool {
	if err == nil {
		return false
	}
...
func ChargeViolationFeeIfNeeded(ctx *gin.Context, relayInfo *relaycommon.RelayInfo, apiErr *types.AIBridgeError) bool {
