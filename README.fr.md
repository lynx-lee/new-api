...
<p align="center">
  <a href="https://raw.githubusercontent.com/Calcium-Ion/ai-bridge/main/LICENSE">
    <img src="https://img.shields.io/github/license/Calcium-Ion/ai-bridge?color=brightgreen" alt="licence">
  </a><!--
  --><a href="https://github.com/Calcium-Ion/ai-bridge/releases/latest">
    <img src="https://img.shields.io/github/v/release/Calcium-Ion/ai-bridge?color=brightgreen&include_prereleases" alt="version">
  </a><!--
...
<p align="center">
  <strong>Merci à <a href="https://www.jetbrains.com/?from=ai-bridge">JetBrains</a> pour avoir fourni une licence de développement open-source gratuite pour ce projet</strong>
</p>
...
📖 Pour plus de méthodes de déploiement, veuillez vous référer à [Guide de déploiement](https://docs.aibridge.pro/en/docs/installation)
...
### 📖 [Documentation officielle](https://docs.aibridge.pro/en/docs) | [![Demander à DeepWiki](https://deepwiki.com/badge.svg)](https://deepwiki.com/QuantumNous/ai-bridge)
...
| Catégorie | Lien |
|------|------|
| 🚀 Guide de déploiement | [Documentation d'installation](https://docs.aibridge.pro/en/docs/installation) |
| ⚙️ Configuration de l'environnement | [Variables d'environnement](https://docs.aibridge.pro/en/docs/installation/config-maintenance/environment-variables) |
| 📡 Documentation de l'API | [Documentation de l'API](https://docs.aibridge.pro/en/docs/api) |
| ❓ FAQ | [FAQ](https://docs.aibridge.pro/en/docs/support/faq) |
| 💬 Interaction avec la communauté | [Canaux de communication](https://docs.aibridge.pro/en/docs/support/community-interaction) |

---

## ✨ Fonctionnalités clés

> Pour les fonctionnalités détaillées, veuillez vous référer à [Présentation des fonctionnalités](https://docs.aibridge.pro/en/docs/guide/wiki/basic-concepts/features-introduction) |
...
- ⚡ [OpenAI Realtime API](https://docs.aibridge.pro/en/docs/api/ai-model/realtime/create-realtime-session) (y compris Azure)
...
- 🔄 [Modèles Rerank](https://docs.aibridge.pro/en/docs/api/ai-model/rerank/create-rerank) (Cohere, Jina)
...
> Pour les détails, veuillez vous référer à [Documentation de l'API - Interface de relais](https://docs.aibridge.pro/en/docs/api)

| Type de modèle | Description | Documentation |
|---------|------|------|
| 🤖 OpenAI-Compatible | Modèles compatibles OpenAI | [Documentation](https://docs.aibridge.pro/en/docs/api/ai-model/chat/openai/createchatcompletion) |
| 🤖 OpenAI Responses | Format OpenAI Responses | [Documentation](https://docs.aibridge.pro/en/docs/api/ai-model/chat/openai/createresponse) |
...
| 💬 Claude | Format Messages | [Documentation](https://docs.aibridge.pro/en/docs/api/ai-model/chat/createmessage) |
| 🌐 Gemini | Format Google Gemini | [Documentation](https://docs.aibridge.pro/en/docs/api/ai-model/chat/gemini/geminirelayv1beta) |
| 🔧 Dify | Mode ChatFlow | - |
...
- [Interface de discussion (Chat Completions)](https://docs.aibridge.pro/en/docs/api/ai-model/chat/openai/createchatcompletion)
- [Interface de réponse (Responses)](https://docs.aibridge.pro/en/docs/api/ai-model/chat/openai/createresponse)
- [Interface d'image (Image)](https://docs.aibridge.pro/en/docs/api/ai-model/images/openai/post-v1-images-generations)
- [Interface audio (Audio)](https://docs.aibridge.pro/en/docs/api/ai-model/audio/openai/create-transcription)
- [Interface vidéo (Video)](https://docs.aibridge.pro/en/docs/api/ai-model/audio/openai/createspeech)
- [Interface d'incorporation (Embeddings)](https://docs.aibridge.pro/en/docs/api/ai-model/embeddings/createembedding)
- [Interface de rerank (Rerank)](https://docs.aibridge.pro/en/docs/api/ai-model/rerank/creatererank)
- [Conversation en temps réel (Realtime)](https://docs.aibridge.pro/en/docs/api/ai-model/realtime/createrealtimesession)
- [Discussion Claude](https://docs.aibridge.pro/en/docs/api/ai-model/chat/createmessage)
- [Discussion Google Gemini](https://docs.aibridge.pro/en/docs/api/ai-model/chat/gemini/geminirelayv1beta)
...
> [!TIP]
> **Dernière image Docker:** `calciumion/ai-bridge:latest`
...
| `PYROSCOPE_APP_NAME` | Nom de l'application Pyroscope | `ai-bridge` |
...
| `HOSTNAME` | Nom d'hôte tagué pour Pyroscope | `ai-bridge` |

📖 **Configuration complète:** [Documentation des variables d'environnement](https://docs.aibridge.pro/en/docs/installation/config-maintenance/environment-variables)
...
2. Recherchez **AI-Bridge** dans le magasin d'applications
...
| [ai-bridge-horizon](https://github.com/Calcium-Ion/ai-bridge-horizon) | Version optimisée haute performance de AI Bridge |
...
| 📘 FAQ | [FAQ](https://docs.aibridge.pro/en/docs/support/faq) |
| 💬 Interaction avec la communauté | [Canaux de communication](https://docs.aibridge.pro/en/docs/support/community-interaction) |
| 🐛 Commentaires sur les problèmes | [Commentaires sur les problèmes](https://docs.aibridge.pro/en/docs/support/feedback-issues) |
| 📚 Documentation complète | [Documentation officielle](https://docs.aibridge.pro/en/docs) |
...
[![Graphique de l'historique des étoiles](https://api.star-history.com/svg?repos=Calcium-Ion/ai-bridge&type=Date)](https://star-history.com/#Calcium-Ion/ai-bridge&Date)
...
### 💖 Merci d'utiliser AI Bridge

Si ce projet vous est utile, bienvenue à nous donner une ⭐️ Étoile！

**[Documentation officielle](https://docs.aibridge.pro/en/docs)** • **[Commentaires sur les problèmes](https://github.com/Calcium-Ion/ai-bridge/issues)** • **[Dernière version](https://github.com/Calcium-Ion/ai-bridge/releases)**
