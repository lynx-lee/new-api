# AI Bridge Electron Desktop App

This directory contains the Electron wrapper for AI Bridge, providing a native desktop application with system tray support for Windows, macOS, and Linux.
...
```bash
# If you have a pre-built binary (e.g., ai-bridge-macos)
cp ../ai-bridge-macos ../ai-bridge
```
...
- Store database in `../data/ai-bridge.db`
...
### Database Location
- **Development**: `../data/ai-bridge.db` (project directory)
- **Production**:
  - macOS: `~/Library/Application Support/AI Bridge/data/`
  - Windows: `%APPDATA%/AI Bridge/data/`
  - Linux: `~/.config/AI Bridge/data/`
