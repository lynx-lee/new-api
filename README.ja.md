...
<p align="center">
  <strong>感謝 <a href="https://www.jetbrains.com/?from=ai-bridge">JetBrains</a> が本プロジェクトに無料のオープンソース開発ライセンスを提供してくれたことに感謝します</strong>
</p>
...
📖 その他のデプロイ方法については[デプロイガイド](https://docs.aibridge.pro/ja/docs/installation)を参照してください。
...
### 📖 [公式ドキュメント](https://docs.aibridge.pro/ja/docs) | [![Ask DeepWiki](https://deepwiki.com/badge.svg)](https://deepwiki.com/QuantumNous/ai-bridge)
...
| カテゴリ | リンク |
|------|------|
| 🚀 デプロイガイド | [インストールドキュメント](https://docs.aibridge.pro/ja/docs/installation) |
| ⚙️ 環境設定 | [環境変数](https://docs.aibridge.pro/ja/docs/installation/config-maintenance/environment-variables) |
| 📡 APIドキュメント | [APIドキュメント](https://docs.aibridge.pro/ja/docs/api) |
| ❓ よくある質問 | [FAQ](https://docs.aibridge.pro/ja/docs/support/faq) |
| 💬 コミュニティ交流 | [交流チャネル](https://docs.aibridge.pro/ja/docs/support/community-interaction) |

---

## ✨ 主な機能

> 詳細な機能については[機能説明](https://docs.aibridge.pro/ja/docs/guide/wiki/basic-concepts/features-introduction)を参照してください。
...
**APIフォーマットサポート:**
- ⚡ [OpenAI Responses](https://docs.aibridge.pro/ja/docs/api/ai-model/chat/openai/create-response)
- ⚡ [OpenAI Realtime API](https://docs.aibridge.pro/ja/docs/api/ai-model/realtime/create-realtime-session)（Azureを含む）
- ⚡ [Claude Messages](https://docs.aibridge.pro/ja/docs/api/ai-model/chat/create-message)
- ⚡ [Google Gemini](https://doc.aibridge.pro/ja/api/google-gemini-chat)
- 🔄 [Rerankモデル](https://docs.aibridge.pro/ja/docs/api/ai-model/rerank/create-rerank)（Cohere、Jina）
...
> 詳細については[APIドキュメント - 中継インターフェース](https://docs.aibridge.pro/ja/docs/api)

| モデルタイプ | 説明 | ドキュメント |
|---------|------|------|
| 🤖 OpenAI-Compatible | OpenAI互換モデル | [ドキュメント](https://docs.aibridge.pro/ja/docs/api/ai-model/chat/openai/createchatcompletion) |
| 🤖 OpenAI Responses | OpenAI Responsesフォーマット | [ドキュメント](https://docs.aibridge.pro/ja/docs/api/ai-model/chat/openai/createresponse) |
| 🎨 Midjourney-Proxy | [Midjourney-Proxy(Plus)](https://github.com/novicezk/midjourney-proxy) | [ドキュメント](https://doc.aibridge.pro/api/midjourney-proxy-image) |
| 🎵 Suno-API | [Suno API](https://github.com/Suno-API/Suno-API) | [ドキュメント](https://doc.aibridge.pro/api/suno-music) |
| 🔄 Rerank | Cohere、Jina | [ドキュメント](https://docs.aibridge.pro/ja/docs/api/ai-model/rerank/creatererank) |
| 💬 Claude | Messagesフォーマット | [ドキュメント](https://docs.aibridge.pro/ja/docs/api/ai-model/chat/createmessage) |
| 🌐 Gemini | Google Geminiフォーマット | [ドキュメント](https://docs.aibridge.pro/ja/docs/api/ai-model/chat/gemini/geminirelayv1beta) |
| 🔧 Dify | ChatFlowモード | - |
...
- [チャットインターフェース (Chat Completions)](https://docs.aibridge.pro/ja/docs/api/ai-model/chat/openai/createchatcompletion)
- [レスポンスインターフェース (Responses)](https://docs.aibridge.pro/ja/docs/api/ai-model/chat/openai/createresponse)
- [イメージインターフェース (Image)](https://docs.aibridge.pro/ja/docs/api/ai-model/images/openai/post-v1-images-generations)
- [オーディオインターフェース (Audio)](https://docs.aibridge.pro/ja/docs/api/ai-model/audio/openai/create-transcription)
- [ビデオインターフェース (Video)](https://docs.aibridge.pro/ja/docs/api/ai-model/audio/openai/createspeech)
- [エンベッドインターフェース (Embeddings)](https://docs.aibridge.pro/ja/docs/api/ai-model/embeddings/createembedding)
- [再ランク付けインターフェース (Rerank)](https://docs.aibridge.pro/ja/docs/api/ai-model/rerank/creatererank)
- [リアルタイム対話インターフェース (Realtime)](https://docs.aibridge.pro/ja/docs/api/ai-model/realtime/createrealtimesession)
- [Claudeチャット](https://docs.aibridge.pro/ja/docs/api/ai-model/chat/createmessage)
- [Google Geminiチャット](https://docs.aibridge.pro/ja/docs/api/ai-model/chat/gemini/geminirelayv1beta)
...
> [!TIP]
> **最新のDockerイメージ:** `calciumion/ai-bridge:latest`
...
| `PYROSCOPE_APP_NAME` | Pyroscopeアプリ名 | `ai-bridge` |
...
| `HOSTNAME` | Pyroscope用のホスト名タグ | `ai-bridge` |

📖 **完全な設定:** [環境変数ドキュメント](https://docs.aibridge.pro/ja/docs/installation/config-maintenance/environment-variables)
...
1. 宝塔パネル（**9.2.0バージョン**以上）をインストールし、アプリケーションストアで**AI-Bridge**を検索してインストールします。
...
| [ai-bridge-horizon](https://github.com/Calcium-Ion/ai-bridge-horizon) | AI Bridge高性能最適化版 |
...
| 📘 よくある質問 | [FAQ](https://docs.aibridge.pro/ja/docs/support/faq) |
| 💬 コミュニティ交流 | [交流チャネル](https://docs.aibridge.pro/ja/docs/support/community-interaction) |
| 🐛 問題のフィードバック | [問題フィードバック](https://docs.aibridge.pro/ja/docs/support/feedback-issues) |
| 📚 完全なドキュメント | [公式ドキュメント](https://docs.aibridge.pro/ja/docs) |
...
[![スター履歴チャート](https://api.star-history.com/svg?repos=Calcium-Ion/ai-bridge&type=Date)](https://star-history.com/#Calcium-Ion/ai-bridge&Date)
...
### 💖 AI Bridgeをご利用いただきありがとうございます

このプロジェクトがあなたのお役に立てたなら、ぜひ ⭐️ スターをください！

**[公式ドキュメント](https://docs.aibridge.pro/ja/docs)** • **[問題フィードバック](https://github.com/Calcium-Ion/ai-bridge/issues)** • **[最新リリース](https://github.com/Calcium-Ion/ai-bridge/releases)**
