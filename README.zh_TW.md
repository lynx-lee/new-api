...
<p align="center">
  <strong>感謝 <a href="https://www.jetbrains.com/?from=ai-bridge">JetBrains</a> 為本項目提供免費的開源開發許可證</strong>
</p>
...
📖 更多部署方式請參考 [部署指南](https://docs.aibridge.pro/zh/docs/installation)
...
### 📖 [官方文件](https://docs.aibridge.pro/zh/docs) | [![Ask DeepWiki](https://deepwiki.com/badge.svg)](https://deepwiki.com/QuantumNous/ai-bridge)
...
| 分類 | 連結 |
|------|------|
| 🚀 部署指南 | [安裝文件](https://docs.aibridge.pro/zh/docs/installation) |
| ⚙️ 環境配置 | [環境變數](https://docs.aibridge.pro/zh/docs/installation/config-maintenance/environment-variables) |
| 📡 接口文件 | [API 文件](https://docs.aibridge.pro/zh/docs/api) |
| ❓ 常見問題 | [FAQ](https://docs.aibridge.pro/zh/docs/support/faq) |
| 💬 社群交流 | [交流管道](https://docs.aibridge.pro/zh/docs/support/community-interaction) |

---

## ✨ 主要特性

> 詳細特性請參考 [特性說明](https://docs.aibridge.pro/zh/docs/guide/wiki/basic-concepts/features-introduction)
...
> 詳情請參考 [接口文件 - 中繼接口](https://docs.aibridge.pro/zh/docs/api)

| 模型類型 | 說明 | 文件 |
|---------|------|------|
| 🤖 OpenAI-Compatible | OpenAI 兼容模型 | [文件](https://docs.aibridge.pro/zh/docs/api/ai-model/chat/openai/createchatcompletion) |
| 🤖 OpenAI Responses | OpenAI Responses 格式 | [文件](https://docs.aibridge.pro/zh/docs/api/ai-model/chat/openai/createresponse) |
| 🎨 Midjourney-Proxy | [Midjourney-Proxy(Plus)](https://github.com/novicezk/midjourney-proxy) | [文件](https://doc.aibridge.pro/api/midjourney-proxy-image) |
| 🎵 Suno-API | [Suno API](https://github.com/Suno-API/Suno-API) | [文件](https://doc.aibridge.pro/api/suno-music) |
| 🔄 Rerank | Cohere、Jina | [文件](https://docs.aibridge.pro/zh/docs/api/ai-model/rerank/create-rerank) |
| 💬 Claude | Messages 格式 | [文件](https://docs.aibridge.pro/zh/docs/api/ai-model/chat/createmessage) |
| 🌐 Gemini | Google Gemini 格式 | [文件](https://docs.aibridge.pro/zh/docs/api/ai-model/chat/gemini/geminirelayv1beta) |
| 🔧 Dify | ChatFlow 模式 | - |
| 🎯 自訂 | 支援完整調用位址 | - |
...
- [響應接口 (Responses)](https://docs.aibridge.pro/zh/docs/api/ai-model/chat/openai/createresponse)
- [圖像接口 (Image)](https://docs.aibridge.pro/zh/docs/api/ai-model/images/openai/post-v1-images-generations)
- [音訊接口 (Audio)](https://docs.aibridge.pro/zh/docs/api/ai-model/audio/openai/create-transcription)
- [影片接口 (Video)](https://docs.aibridge.pro/zh/docs/api/ai-model/audio/openai/createspeech)
...
- [即時對話 (Realtime)](https://docs.aibridge.pro/zh/docs/api/ai-model/realtime/createrealtimesession)
...
> [!TIP]
> **最新版 Docker 鏡像：** `calciumion/ai-bridge:latest`
...
| `PYROSCOPE_APP_NAME` | Pyroscope 應用名                                        | `ai-bridge` |
...
| `HOSTNAME` | Pyroscope 標籤裡的主機名                                          | `ai-bridge` |

📖 **完整配置：** [環境變數文件](https://docs.aibridge.pro/zh/docs/installation/config-maintenance/environment-variables)
...
| [ai-bridge-horizon](https://github.com/Calcium-Ion/ai-bridge-horizon) | AI Bridge 高性能優化版 |
...
| 📘 常見問題 | [FAQ](https://docs.aibridge.pro/zh/docs/support/faq) |
| 💬 社群交流 | [交流管道](https://docs.aibridge.pro/zh/docs/support/community-interaction) |
| 🐛 回饋問題 | [問題回饋](https://docs.aibridge.pro/zh/docs/support/feedback-issues) |
| 📚 完整文件 | [官方文件](https://docs.aibridge.pro/zh/docs) |
...
**[官方文件](https://docs.aibridge.pro/zh/docs)** • **[問題回饋](https://github.com/Calcium-Ion/ai-bridge/issues)** • **[最新發布](https://github.com/Calcium-Ion/ai-bridge/releases)**
