...
function TokensPage() {
  ...
  function openFluentNotification(key) {
    ...
    const container = document.getElementById('fluent-aibridge-container');
    if (!container) {
  ...
  useEffect(() => {
    const selector = '#fluent-aibridge-container';
    ...
    const isOrContainsTarget = (node) => {
      ...
      if (node.id === 'fluent-aibridge-container') return true;
      return (
