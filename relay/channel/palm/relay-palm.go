...
func palmStreamHandler(c *gin.Context, resp *http.Response) (*types.AIBridgeError, string) {
	responseText := ""
...
func palmHandler(c *gin.Context, info *relaycommon.RelayInfo, resp *http.Response) (*dto.Usage, *types.AIBridgeError) {
	responseBody, err := io.ReadAll(resp.Body)
	if err != nil {
