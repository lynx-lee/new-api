...
func OaiStreamHandler(c *gin.Context, info *relaycommon.RelayInfo, resp *http.Response) (*dto.Usage, *types.AIBridgeError) {
...
func OpenaiHandler(c *gin.Context, info *relaycommon.RelayInfo, resp *http.Response) (*dto.Usage, *types.AIBridgeError) {
	defer service.CloseResponseBodyGracefully(resp)
...
func OpenaiRealtimeHandler(c *gin.Context, info *relaycommon.RelayInfo) (*types.AIBridgeError, *dto.RealtimeUsage) {
...
func OpenaiHandlerWithUsage(c *gin.Context, info *relaycommon.RelayInfo, resp *http.Response) (*dto.Usage, *types.AIBridgeError) {
	defer service.CloseResponseBodyGracefully(resp)
