...
func baiduStreamHandler(c *gin.Context, info *relaycommon.RelayInfo, resp *http.Response) (*types.AIBridgeError, *dto.Usage) {
	usage := &dto.Usage{}
...
func baiduHandler(c *gin.Context, info *relaycommon.RelayInfo, resp *http.Response) (*types.AIBridgeError, *dto.Usage) {
...
func baiduEmbeddingHandler(c *gin.Context, info *relaycommon.RelayInfo, resp *http.Response) (*types.AIBridgeError, *dto.Usage) {
