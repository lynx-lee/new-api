...
import (
	...
	"github.com/QuantumNous/ai-bridge/relay/common"
...
func (a *Adaptor) DoResponse(c *gin.Context, resp *http.Response, info *common.RelayInfo) (usage any, err *types.AIBridgeError) {
	if info.IsStream {
