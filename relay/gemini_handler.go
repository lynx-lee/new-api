...
func GeminiHelper(c *gin.Context, info *relaycommon.RelayInfo) (newAPIError *types.AIBridgeError) {
...
func GeminiEmbeddingHandler(c *gin.Context, info *relaycommon.RelayInfo) (newAPIError *types.AIBridgeError) {
	info.InitChannelMeta(c)
